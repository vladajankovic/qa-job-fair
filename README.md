...
- [Fork Repository to your GitHub](https://github.com/LukaVuksic/qa-job-fair) ([How to fork a repo?]([https://github.com/LukaVuksic/qa-job-fair](https://docs.github.com/en/get-started/quickstart/fork-a-repo)))
