...
public class TestGame {
	...
	public void testGameEndingByNoCards1() {
		...
		assertTrue("Game: Player 1 must have 0 cards in both hand and deck!",
				player1.getDeck().isEmpty() && player1.getHand().isEmpty());
		assertTrue("Game: Player 1 has no cards left, gameEnded must be true!", testGame.getGameEnded());
		assertTrue("Game: Player 2 must be the winner!",
				result.equals("Player 1 has no cards in hand and deck. Player 2 wins!"));
	}
	...
	public void testGameEndingByNoCards2() {
		...
		assertTrue("Game: Player 2 must have 0 cards in both hand and deck!",
				player2.getDeck().isEmpty() && player2.getHand().isEmpty());
